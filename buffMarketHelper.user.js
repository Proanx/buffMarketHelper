...
(function () {
    ...
    function paintingGradient(scale, target, position, targetTemplate) {
        ...
        if (targetTemplate) {
            ...
            template = '<strong class="f_16px f_Strong price_scale l_Right"></strong>';
        }
